    ...
    if($_SERVER['REQUEST_METHOD']=='GET')
        {
          ...
          $com=$this->Model->getOne('ststm_communes',array('COMMUNE_ID'=>$ticket['COMMUNE_ID']));
          $data['prov']=$this->Model->getOne('ststm_provinces',array('PROVINCE_ID'=>$com['PROVINCE_ID']));
...
$tableaudata[]=$alert_notif;
    ...
    public function getCommune(){
      $id_pro=$_POST['id'];
      $id_com=$_POST['com'];
      $commune=$this->Model->getListOrder('ststm_communes',array('PROVINCE_ID'=>$id_pro),'COMMUNE_NAME');

      $com="<option value=''>--choisir--</option>";
      foreach ($commune as $value) {
        if ($value['COMMUNE_ID']==$id_com) {
           $com.="<option value='".$value['COMMUNE_ID']."' selected>".$value['COMMUNE_NAME']."</option>";
        }else
        $com.="<option value='".$value['COMMUNE_ID']."'>".$value['COMMUNE_NAME']."</option>";
      }
