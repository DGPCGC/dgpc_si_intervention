...
<div class="list-group">
  ...
  <a href="<?php echo base_url() ?>alerte/Instititions/index" class="btn-xs list-group-item">Institutions &agrave; notifier</a>
  <a href="<?php echo base_url() ?>alerte/Personnel/index" class="btn-xs list-group-item active">Personnes &agrave; notifier</a>
</div>
<div class="list-group">
