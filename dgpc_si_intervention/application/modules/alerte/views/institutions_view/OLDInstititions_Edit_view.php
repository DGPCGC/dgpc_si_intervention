...
<div class="list-group">
  ...
  <a href="<?php echo base_url() ?>alerte/Instititions" class="btn-xs list-group-item <?php if($this->router->class=='Instititions' && $this->router->method=='index') echo 'active';?>">Liste</a>
   ...
   <!-- <li <?php if($this->router->class=='Instititions' && $this->router->method=='addform') echo "class='active'";?>><a href="<?php echo base_url() ?>alerte/Instititions/addform" class="btn-xs">Nouvelle</a></li> -->
  
   <!-- <li <?php if($this->router->class=='Instititions' && $this->router->method=='index') echo "class=''";?>><a href="<?php echo base_url() ?>alerte/Instititions" class="btn-xs">Liste</a></li> -->
