                        ...
                        <table class="table table-bordered">
                            ...
                            <?php 
                              ...
                              <tr>
                                ...
                                <td><a href="<?=base_url().'tickets/Intervention/supprimer_degat_materiel/'.$dg_humain['DEGAT_HUMAIN_ID'].'/'.$ticket['TICKET_CODE']?>" class='btn btn-danger btn-sm'> Supprimer</a></td>
                              </tr>
                               <?php 
                              }
                            ?>
                              ...
                              foreach ($degat_humain_dg as $dg_humain_dgpc) {
                                ?>
                                 <tr>
                                   ...
                                   <td><a href="<?=base_url().'tickets/Intervention/supprimer_degat_humain_dgpc/'.$dg_humain_dgpc['DEGAT_HUMAIN_ID'].'/'.$ticket['TICKET_CODE']?>" class='btn btn-danger btn-sm'> Supprimer</a></td>
                                 </tr>
                                <?php
                              }
                            ?>
                            ...
                            <?php 
                              ...
                              //  print_r($dg_materiel_dgpc);
                                ...
                                <tr>
                                  ...
                                  <td><a href="<?=base_url().'tickets/Intervention/supprimer_degat_materiel_dgpc/'.$dg_materiel_dgpc['DEGAT_MATERIEL_ID'].'/'.$ticket['TICKET_CODE']?>" class='btn btn-danger btn-sm'> Supprimer</a></td>
                                </tr>
                                <?php
                              }
                            ?>
