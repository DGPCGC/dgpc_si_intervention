            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 5px" id="navp">
                ...
                <div class="container-fluid">
                  ...
                  <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 20px">
                    ...
                    <?php
                      $this->uri->segment(4);
                      $check=$this->Model->checkvalue('transm_rapport_histo',array('TICKET_CODE'=>$this->uri->segment(4),'NIVEAU_ID'=>2,'STATUT'=>3));
                      if($check!=TRUE){
                  ...
                  ?>
                    ...
                    <div role='tabpanel' class='tab-pane' id='valider'>
                      <?php
                        $commentaire=$this->Model->getOne('transm_rapport_histo',array('TICKET_CODE'=>$this->uri->segment(4),'USER_ID'=>$this->session->userdata('DGPC_USER_ID'),'NIVEAU_ID'=>2));
                       ?>
                      <form method="POST" action="<?=base_url().'tickets/Intervention/valider_transmission_cppc/'.$ticket['TICKET_CODE']?>">
                          <div class="col-lg-6 col-md-6">
