                ...
                <div class="container-fluid">
                  ...
                  <div class="col-lg-12  jumbotron jumbotron-fluid" style="padding: 5px">
                    ...
                    if (!$equipe_intervenant) {
                     $n_equipe.="<span style='color:red'>AUCUN</span>-";
                    }
                    $n_equipe.="|";
                    ...
                    foreach ($blesse as $value) {
                      ...
                      $bls.="<tr><td>".$i."</td><td>".$value['NOM_PRENOM']."</td><td>".$value['SEVERITE']."</td><td>".$value['OBSERVATION']."</td><td>".$is_dgpc."</td></tr>";
                      $i++;
                    }
                    ?>
...
Highcharts.chart('mtrl', {
    ...
    title: {
        text: 'DEGATS HUMAINS ET MATERIELS DU TIQUET <?=$this->uri->segment(4)?>'
    },
    subtitle: {
...
Highcharts.chart('mrts', {
   ...
   title: {
    ...
    xAxis: {
        ...
        categories: ['OUVERT<?=$ouverture?>', 'SORTIR CPPC<?=$sortie?>', 'ON SITE<?=$arriver?>', 'DEPART<?=$depart?>', 'RETOUR CPPC<?=$retour?>','CLOTURE<?=$cloture?>'],
        title: {
            text: null
        }
    },
    ...
    series: [{
        ...
        data: [ <?=$ouverture_val?>, <?=$sortie_val?>, <?=$arriver_val?>, <?=$depart_val?>,<?=$retour_val?>,<?=$cloture_val?>]
    }
    // , {
    //     name: ' ',
