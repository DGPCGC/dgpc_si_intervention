...
/*-------------------*/
   ...
   // echo "datecreation : ".$datecreation;
    ...
    if(!empty($CPPC_ID)){
       ...
       $crit_cnl = " PROVINCE_ID IN (";
        ...
        $conv_date=new DateTime($datecreation);
        $dat_verif=$conv_date->format('Y-m-d');
 

    if(!empty($datecreation)){
      if(!empty($criteresnew)){
         $criteresnew.=' AND DATE_INSERTION LIKE "%'.$dat_verif.'%" ';
      }else{
        $criteresnew.=' DATE_INSERTION LIKE "%'.$dat_verif.'%" ';
      }
