                                    ...
                                    for (var i = 0; i < donnes.length; i++) {
                                                 ...
                                                 var Icone = new BPSIcon({iconUrl: currentSA[4]});
                                                      ...
                                                      title: "DESCRIPTION : "+currentSA[1],
                                                         ...
                                                         .bindPopup("<center><label>"+currentSA[7]+"</label></center></br>______________________________</br>DESCRIPTION : "+currentSA[1]+"<br>");
                                                     }
                      ...
                      <div class="col-md-3">
                        <table class="table table-striped table-hover">
                          ...
                          <?php 
                           ...
                           ?>
                          <tr>
                            <td>CPPC</td><td style="background: ;"><input name="chk1" onchange="submit_fx()" <?= $checked; ?> type="checkbox"  value="1" name=""></td>
                             <td class="input-sm"> <label style="width: 20px; background: green"><font color="green">In</font></label></td> 
                          </tr>
                          <tr style="background:">
                            <td>Ticket</td><td><input name="chk2" onchange="submit_fx()" <?= $checked2; ?> type="checkbox" value="0" name=""></td>
