                ...
                <div class="container-fluid">
                  ...
                  <div class="col-lg-12" style="padding: 5px">
                      <?php
                       ...
                       ?>   
                      <form method="POST" action="<?=base_url().'equipes/Ccpc/save'?>">
                           <div class="col-lg-12 col-md-12">
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <?php
                                       foreach ($ccpc as $ccpcs) {
                                         if($ccpcs['CPPC_ID'] == set_value('SERVICE_DGPC_ID')){
                                          ?>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="text" class="form-control" name="CCPC_DESCR" value="<?=set_value('CCPC_DESCR')?>"> 
                              ...
                              <div class="row">
                               ...
                               <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="text" class="form-control" name="CCPC_LONG" value="-1">
                               ...
                               <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="text" class="form-control" name="CCPC_LAT" value="-1">
