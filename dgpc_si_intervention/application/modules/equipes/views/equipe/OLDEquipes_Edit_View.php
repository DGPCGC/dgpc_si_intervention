                      ...
                      <form method="POST" action="<?=base_url().'equipes/Equipes/saveModification/'.$equipe['EQUIPE_ID']?>">
                           <div class="col-lg-6 col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="EQUIPE_NOM" value="<?=$equipe['EQUIPE_NOM']?>" style="text-transform: capitalize;" onkeypress="return (envent.charCode > 64 && envent.charCode < 91) || (envent.charCode > 96  && envent.charCode < 123)" autofocus> 
                                  <font color='red'><?php echo form_error('EQUIPE_NOM'); ?></font>               
                              </div>
                              <div class="form-group">
                                  <label>Email</label>
                                  <input type="Email" class="form-control" name="EQUIPE_EMAIL" value="<?=$equipe['EQUIPE_EMAIL']?>">
