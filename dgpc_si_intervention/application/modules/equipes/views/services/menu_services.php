<ul class="nav nav-pills pull-right">
   <li <?php if($this->router->class=='Services' && $this->router->method=='ajouter') echo "class='active'";?>><a href="<?php echo base_url() ?>equipes/Services/ajouter" class="btn-xs">Nouveau</a></li>
