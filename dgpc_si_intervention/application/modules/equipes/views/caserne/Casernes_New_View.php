                           ...
                           <div class="col-lg-12 col-md-12">
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    <input type="text" class="form-control" name="CPPC_NOM" value="<?=set_value('CPPC_NOM')?>" style="text-transform: capitalize;" onkeypress="return (envent.charCode > 64 && envent.charCode < 91) || (envent.charCode > 96  && envent.charCode < 123)" autofocus> 
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="Email" class="form-control" name="CPPC_EMAIL" value="<?=set_value('CPPC_EMAIL')?>">
                              ...
                              <div class="row">
                                <div class="col-lg-3 col-md-3">
                                 ...
                                 <div class="col-lg-6 col-md-6 form-group"> 
                                 <input type="number" class="form-control" name="CPPC_TEL" value="<?=set_value('CPPC_TEL')?>">
