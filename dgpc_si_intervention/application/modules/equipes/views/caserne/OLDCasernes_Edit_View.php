                ...
                <div class="container-fluid">
                  ...
                  <div class="col-lg-12" style="padding: 5px">
                      <?php
                       ...
                       ?>   
                      <form method="POST" action="<?=base_url().'equipes/Caserne/saveModification/'.$cppc['CPPC_ID']?>">
                           <div class="col-lg-12 col-md-12">
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    <input type="text" class="form-control" name="CPPC_NOM" style="text-transform: capitalize;" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" value="<?=$cppc['CPPC_NOM']?>" autofocus> 
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="text" class="form-control" name="CPPC_DESCR" value="<?=$cppc['CPPC_DESCR']?>"> 
                                  ...
                                  <select name="SERVICE_DGPC_ID" class="form-control">
                                    ...
                                    <?php
                                       foreach ($services as $service) {
                                         if($service['SERVICE_DGPC_ID'] == $cppc['SERVICE_DGPC_ID']){
                                          ?>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="text" class="form-control" name="CPPC_EMAIL" value="<?=$cppc['CPPC_EMAIL']?>">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="text" class="form-control" name="CPPC_TEL" value="<?=$cppc['CPPC_TEL']?>">
                              ...
                              <div class="row">
                                  ...
                                  <select name="PROVINCE_ID" class="form-control">
                                    ...
                                    <?php
                                       foreach ($provinces as $province) {
                                         if($province['PROVINCE_ID'] == $cppc['PROVINCE_ID']){
                                          ?>
                               ...
                               <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="text" class="form-control" name="CASERNE_LONG" value="<?=$cppc['LONGITUDE'] ?>">
                               ...
                               <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                  <input type="text" class="form-control" name="CASERNE_LAT" value="<?=$cppc['LATITUDE'] ?>">
