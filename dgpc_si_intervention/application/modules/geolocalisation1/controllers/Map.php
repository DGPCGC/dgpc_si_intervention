   ...
   // $send_alarm=1;
    ...
    function map_cppc(){
          ...
          if(isset($OUV)){
            ...
            $nbtik=$this->Model->querysqlOne('SELECT COUNT(*)nbtik FROM tk_ticket WHERE STATUT_ID = 1');
         ...
         $caserne = $this->Model->getList('rh_cppc',array());
          ...
          $table_cppc='<div class="table-responsive"><table id="mytables" class="table table-bordered table-stripped table-hover table-condensed table-responsive">
                        ...
                        <th  colspan="2">Dégâts matériels</th>
                        <th colspan="4">Dégâts humains</th>
                        <th  rowspan="3">Tableau de board</th>
                        </tr>
                        <tr>
          ...
          $table_cppc.='<tr>
                          ...
                          <td><b style="float:right">'.$nb_pe_morts.'</b></td><td>
                          '.$nbint['nb_peuple'].' Intervention(s) , Materiels disponible '.$dispo.' ,  
                          ';
