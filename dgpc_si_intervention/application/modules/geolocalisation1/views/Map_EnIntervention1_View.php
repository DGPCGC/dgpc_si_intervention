...
<head>
<?php include VIEWPATH.'includes/header1.php' ?>
...
<body onload="SendNotificationSound(<?= $bruit; ?>)">
                    ...
                    <div class="row">
                        <div class="col-lg-12" style=" margin-bottom: 5px">
                            ...
                            <div class="row" id="conta" style="margin-top: -10px">
                                ...
                                <form action="<?=base_url().'geolocalisation/Map1/enintervention'?>" name="myform" method="POST"> 
  ...
  <script type="text/javascript">
   ...
   // alert(id);
    ...
    $.ajax({
                            url:"<?php echo base_url() ?>geolocalisation/Map1/ajouter_commune",
                            method:"POST",
                            //async:false,
                            data: {id:id},
