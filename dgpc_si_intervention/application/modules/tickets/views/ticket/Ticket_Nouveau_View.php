                    ...
                    <div class="tab-content">
                        ...
                        <form method="POST" action="<?=base_url().'tickets/Tickets/save'?>">
                              ...
                              <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="TICKET_DECLARANT" value="<?=set_value('TICKET_DECLARANT')?>" style="text-transform: capitalize;" onkeypress="return (envent.charCode > 64 && envent.charCode < 91) || (envent.charCode > 96  && envent.charCode < 123)">
                           ...
                           <?php
                              ...
                              <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" name="NOMBRE_BLESSE" value="<?=set_value('NOMBRE_BLESSE')?>">
                              ...
                              <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" name="NOMBRE_MORT" value="<?=set_value('NOMBRE_MORT')?>">
                                  <font color='red'><?php echo form_error('NOMBRE_MORT'); ?></font>
                                </div>
                              </div>
                              <div class="col-12 col-md-12">
                                <div class="form-group">
                                 <input type="button" class="btn btn-success" value="Précédent" onclick='precent_description()'>
                      ...
                      <div role='tabpanel' class='tab-pane' id='qualification'>
                          ...
                          <div class="col-lg-12 col-md-12">
                           ...
                           <div class="col-12 col-md-12">
                                <div class="form-group">
                                 <input type="button" class="btn btn-success" value="Précédent" onclick='precent_impact()'>
                         ...
                         <div class="col-lg-6 col-md-6">
                           <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                  ...
                                  <input type="button" id='ajout_appui' class='btn btn-info' value="DEMANDE D'APPUIE">
                          ...
                          <!-- <div class="col-lg-12 col-md-12">
                           ...
                           <div class="col-12 col-md-12">
                              <div class="col-12 col-md-12">
                                <div class="form-group">
                                <input type="button" class="btn btn-success" value="Précédent" onclick="precent_qualification()">
