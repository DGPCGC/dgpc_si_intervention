                          ...
                          <form method="POST" action="<?=base_url().'tickets/Tickets/save_modification/'.$ticket['TICKET_ID']?>">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="TICKET_DECLARANT" value="<?=$ticket['TICKET_DECLARANT']?>" style="text-transform: capitalize;" onkeypress="return (envent.charCode > 64 && envent.charCode < 91) || (envent.charCode > 96  && envent.charCode < 123)" autofocus>
                        ...
                        <div role='tabpanel' class='tab-pane' id='impact'>
                          ...
                          <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" name="NOMBRE_BLESSE" value="<?=$ticket['NOMBRE_BLESSE']?>">
                          ...
                          <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" name="NOMBRE_MORT" value="<?=$ticket['NOMBRE_MORT']?>">
