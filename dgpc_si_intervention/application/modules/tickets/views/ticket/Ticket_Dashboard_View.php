...
<script src="https://cdnjs.cloudflare.com/ajax/libs/amstockchart/3.13.0/exporting/rgbcolor.js"></script>
<!-- <script type="text/javascript" src="http://canvg.googlecode.com/svn/trunk/StackBlur.js"></script> -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/stackblur-canvas/2.2.0/stackblur.js"></script>
                ...
                <div class="container-fluid">
                  ...
                  <div class="col-lg-12  jumbotron jumbotron-fluid" style="padding: 5px">
                    ...
                    foreach ($mort as $value) {
                      ...
                      $mrt.="<tr><td>".$i."</td><td>".$n_p."</td><td>".$value['SEXE']."</td><td>".$value['OBSERVATION']."</td><td>".$is_dgpc."</td></tr>";
                      $i++;
                    }
                    ?>
                                        ...
                                        <div class='modal-body'>
                                          <h3>LISTE DES MORTS</h3>
                                            <table id='mort_pers' class='table table-bordered  table-responsive'>
                                              <thead><tr><th>No</th><th>INDIVIDU</th><th>SEXE</th><th>OBSERVATION</th><th>PERSONNEL DGPC?</th></tr></thead><tbody><?=$mrt?></tbody>
                                            </table>
                                        </div>
                    ...
                    foreach ($blesse as $value) {
                      ...
                      $bls.="<tr><td>".$i."</td><td>".$n_p."</td><td>".$value['SEXE']."</td><td>".$value['SEVERITE']."</td><td>".$value['OBSERVATION']."</td><td>".$is_dgpc."</td></tr>";
                      $i++;
                    }
                    ?>
                                        ...
                                        <div class='modal-body'>
                                          <h3>LISTE DES BLESSES</h3>
                                            <table id='blesse_prsone' class='table table-bordered  table-responsive'>
                                              <thead><tr><th>No</th><th>INDIVIDU</th><th>SEXE</th><th>SEVERITE</th><th>OBSERVATION</th><th>PERSONNEL DGPC?</th></tr></thead><tbody><?=$bls?></tbody>
                                            </table>
                                        </div>
...
<script type="text/javascript">
     $(document).ready(function(){
      ...
      $.ajax({
       ...
       $(document).ready(function () { 
        var svg = document.getElementById('mtrl').children[0].innerHTML;
        ...
        $.ajax({
          type: "POST",
          url:" <?php echo base_url() ?>pdf/Pdf_Dashboad/saveImage/<?=$this->uri->segment(4)?>" ,
          data: data,
          success: function(data){
            // alert(data);
          }
