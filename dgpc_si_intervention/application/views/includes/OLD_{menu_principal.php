                ...
                <div class="row" style="margin: 2px;">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="<?=base_url('materiaux/Materiaux')?>" id="men">Matériels</a></li>
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                     ...
                     <?php
                      ...
                      ?>
                      <li><a href="<?=base_url()?>administration/Collaborateurs/liste_collaborateur">Gestion des Collaborateurs</a></li>
                      <?php
                       } ?>
                       <?php
                         ...
                         <li><a href="<?=base_url()?>administration/Fonctionnalites/liste">Gestion des Fonctionnalités</a></li>                       
                          <?php
                             ...
                             <?php 
                              ...
                              <?php } ?>
                        <li><a href="<?=base_url('materiaux/Materiaux')?>" id="men">Gestion des Matériels</a></li>
                       <?php
                                             
                     if($this->mylibrary->get_permission('Profiles') ==1){
                      ?>
                      <li><a href="<?=base_url()?>administration/Profiles/liste">Gestion des Profils</a></li>
                      <?php
                       }
